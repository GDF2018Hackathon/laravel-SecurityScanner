...
class RouteCollectionTest extends TestCase
{
    ...
    public function testAddCollection()
    {
        ...
        $this->assertSame(
            array('bar' => $bar, 'foo' => $foo, 'grandchild' => $grandchild, 'last' => $last), $collection->all(),
    ...
    public function testAddDefaultsAndRequirementsAndOptions()
    {
        ...
        $this->assertEquals(
            array('_controller' => 'fixed', 'placeholder' => 'new-default'), $collection->get('bar')->getDefaults(),
        ...
        $this->assertEquals(
            array('placeholder' => '\d+'), $collection->get('bar')->getRequirements(),
    ...
    public function testResource()
    {
        ...
        $this->assertEquals(
            array($foo, $bar), $collection->getResources(),
