...
class Swift_Transport_LoadBalancedTransportTest extends \SwiftMailerTestCase
{
    public function testEachTransportIsUsedInTurn()
    {
        ...
        $t1->shouldReceive('send')
            ...
            ->andReturnUsing(
                function () use (&$connectionState1, $testCase) {
                    if ($connectionState1) {
                        return 1;
                    }
                    $testCase->fail();
        ...
        $t2->shouldReceive('send')
            ...
            ->with($message2, \Mockery::any())
            ->andReturnUsing(
                function () use (&$connectionState2, $testCase) {
                    if ($connectionState2) {
                        return 1;
                    }
                    $testCase->fail();
    ...
    public function testMessageCanBeTriedOnNextTransportIfExceptionThrown()
    {
        ...
        $t1->shouldReceive('send')
            ...
            ->andReturnUsing(
                function () use (&$connectionState1, $e, $testCase) {
                    if ($connectionState1) {
                        throw $e;
                    }
                    $testCase->fail();
    ...
    public function testExceptionIsThrownIfAllTransportsDie()
    {
        ...
        $t1->shouldReceive('send')
            ...
            ->with($message, \Mockery::any())
            ->andReturnUsing(
                function () use (&$connectionState1, $e) {
                    if ($connectionState1) {
                        throw $e;
                    }
                }
        ...
        $t2->shouldReceive('send')
            ...
            ->with($message, \Mockery::any())
            ->andReturnUsing(
                function () use (&$connectionState2, $e) {
                    if ($connectionState2) {
                        throw $e;
                    }
                }
    ...
    public function testFailureReferenceIsPassedToDelegates()
    {
        ...
        $t1->shouldReceive('send')
            ...
            ->with(
                $message, \Mockery::on(
                    function (&$var) use (&$failures, $testCase) {
